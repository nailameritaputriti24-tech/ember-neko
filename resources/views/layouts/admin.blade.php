                ...
                <div class="mx-auto flex max-w-7xl flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="flex min-w-0 items-center justify-between border-t border-slate-800 lg:border-t-0">
                        <nav class="flex min-w-0 overflow-x-auto px-2 sm:px-4" aria-label="Menu CMS">
                            ...
                            <a href="{{ route('cms.geojson.index') }}" class="shrink-0 border-b-2 px-4 py-4 text-sm font-semibold transition {{ request()->routeIs('cms.geojson.*') ? 'border-red-500 bg-white/10 text-white' : 'border-transparent text-slate-300 hover:border-slate-500 hover:text-white' }}">Layer Wilayah</a>
